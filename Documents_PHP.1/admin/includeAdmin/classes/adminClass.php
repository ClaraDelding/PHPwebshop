...
class Admin  {
    ...
    public function __construct() {
        // Lagrar uppkoppling till databasen i db. 
        $obj = new DB();
        $this->db = $obj->pdo;
    ...
    // Ändra användaruppgifter - OBS! Fungerar ej. 
    ...
    public function listCustomers() {
     ...
     // Ändra användare som admin  - Fungerar ej.    
    ...
    // Hämta vissa kolumner från angiven tabell.
    ...
    // Hämta alla kolumner från (tabellen) för edit
