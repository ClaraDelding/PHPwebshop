...
if (isset($_POST['save'])) {
    ...
    $newProduct->createProduct($productCode, $productName, $productLine, $productScale, $productVendor, 
    $productDescription, $quantityInStock, $buyPrice, $MSRP);
    header('Location: skapa_produkt.php');
...
//Fungerar ej som objektorienterad.
