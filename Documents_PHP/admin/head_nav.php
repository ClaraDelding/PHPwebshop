<header class="mainChild header">
            ...
            <section class="headerSection3 headerSection">
                ...
                <article class="createAcc notLoggedIn">
            ...
            <section class="navSection navSection2">
                <div class="navItemsContainer">
                    <article class="navLinks">
                        <a href="skapa_produkt.php" class=""> Add products </a>
                    </article>
                    <article class="navLinks">
                    ...
                    <article class="navLinks">
                        <a href="#" class="p"> Skapa konto </a>
                    </article>            
                    <article class="navLinks">
                        <a href="#" class="p"> Edit employees </a>
                    </article>
                    <article class="navLinks">
                        <a href="#" class="p"> Skapa konto </a>
                    </article>       
                    <article class="navLinks ">
                        <a href="#" class="p"> Orders </a>
                    </article>   
                </div>
            </section>
